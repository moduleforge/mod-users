...
```sh
go get github.com/moduleforge/users-module/model
```

**Go API** (HTTP handlers and business-logic services):

```sh
go get github.com/moduleforge/users-module/api
```
...
- [docs/users-module-spec.md](./docs/users-module-spec.md) — feature specification and behavioral contracts
