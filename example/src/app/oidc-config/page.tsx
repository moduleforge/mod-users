...
import { ApiRequestError } from '@moduleforge/users-gui';
import { useOptionalAuth } from '@moduleforge/users-gui';
import {
  fetchOIDCSaved,
  fetchOIDCStatus,
  postOIDCConfirm,
...
import type { OIDCProviderAuth } from '@moduleforge/users-gui';
import { Switch } from '@moduleforge/users-gui';
