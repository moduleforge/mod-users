...
CREATE TABLE audit_log (
  ...
  assumed_user_account_id BIGINT REFERENCES user_accounts(id) ON DELETE RESTRICT,
...
CREATE INDEX audit_log_actor_at_idx ON audit_log(actor_user_account_id, at DESC);
