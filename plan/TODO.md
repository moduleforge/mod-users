...
- [ ] [001-update-gui-scripts-and-makefile.md](./phase-02-gui/001-update-gui-scripts-and-makefile.md) — tier `` · branch `phase-02-task-01-update-gui-scripts-and-makefil` · commit `7214b5f` · merge `…`
- [ ] [002-install-gui-deps.md](./phase-02-gui/002-install-gui-deps.md) — tier `` · branch `…` · commit `…` · merge `…`

### Phase 03 — Migrate example/

- [ ] [001-update-example-makefile.md](./phase-03-example/001-update-example-makefile.md) — tier `` · branch `phase-03-task-01-update-example-makefile-for-bu` · commit `8b59697` · merge `…`
