...
- [x] [002-install-gui-deps.md](./phase-02-gui/002-install-gui-deps.md) — tier `` · branch `phase-02-task-02-verify-gui-installs-cleanly-wi` · commit `21309fe` · merge `04617ce`
...
- [x] [002-install-example-deps.md](./phase-03-example/002-install-example-deps.md) — tier `` · branch `phase-03-task-02-verify-example-installs-cleanl` · commit `090c404` · merge `53a6056`

### Phase 04 — Validate full build

- [x] [001-full-build-validation.md](./phase-04-validate/001-full-build-validation.md) — tier `` · branch `phase-04-task-01-full-build-validation` · commit `…` · merge `…`
